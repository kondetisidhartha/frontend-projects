      ...
      <div class="card card-body mb-3">
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <span class="badge badge-success mb-1">Following : ${user.followers}</span>
            <span class="badge badge-warning mb-1">Followers: ${user.following}</span>
            <br><br>
            <ul class="list-group">
